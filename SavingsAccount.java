public class SavingsAccount extends Account{
    ...
    SavingsAccount(String accountHolderName, double balance, String password) {
    ...
    public void withdraw(double amount) throws InvalidInputException, InsufficientFundsException {
        ...
        if ((getBalance() - amount) < MINIMUM_BALANCE)
            throw new InsufficientFundsException("Withdrawal unsuccessful. Account must have a minimum of $50.0");
